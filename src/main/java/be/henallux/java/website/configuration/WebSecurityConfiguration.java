package be.henallux.java.website.configuration;
...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{"/", "/about", "/login", "/cart/**", "/registration/**", "/product/{id}", "/css/**", "/images/**", "/category/{id}"}; // la page login est ici car sinon on ne sait pas changer de langue depuis la page login
