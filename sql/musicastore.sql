...
INSERT INTO `musicastore`.`product` VALUES (1,'Ibanez PF1512 NT 12 Natural', 'Guitare acoustique, dreadnought, cutaway à 12 cordes, corps laminé et finition brillante', 'Ibanez',null,1,239.88,'products/guitares/guitare-7.jpg'),
                                           ...
                                           (16,'Fazley DDK-040','Si vous recherchez un premier kit de batterie abordable sur lequel apprendre les bases à la maison, la Fazley DDK-040 est faite pour vous !','Fazley ',null,4,542,'products/batteries/batterie-electronique-1.jpg'),
                                           (17,'Fazley DDK-120 PRO','Avec cet ensemble très complet, vous êtes paré à toutes les éventualités ! Ce pack comprend une batterie électronique Fazley DDK-120 ','Fazley ',null,4,679,'products/batteries/batterie-electronique-2.jpg'),
                                           (18,'Vangoa Batterie Electronique','Electronic Drum avec 7 Pièces Mesh Kit, Bâtons, et Câble Audio Inclus, , 180 Sons, 10 Pistes Play Along, Connexion USB MIDI','Vangoa ',2,4,348.89,'products/batteries/batterie-electronique-4.jpg'),
                                           (19,'Mapex Armory Shell Set AR728XCJG','La batterie Mapex Armory Shell Set AR728XCJG Ocean Sunset avec Chrome Hardware est une batterie six pièces en édition Limited. ','Mapex Armory ',1,4,999,'products/batteries/batterie-3.jpg'),
                                           ...
                                           (21,'Monzani MZFL-133 Flûte ','L articulation de la tête de la flûte traversière MZFL-133 C donne à l instrument un son équilibré et une réponse très directe. ','Monzani',2,5,149.99,'products/flutes/flute-8.jpg'),
                                           (22,'Yamaha YRT-304B II ','La flûte à bec ténor YAMAHA YRT-304B II a un son riche et plein, bien qu elle soit faite de plastique ABS sans entretien.','Yamaha ',null,5,100,'products/flutes/flute-1.jpg'),
                                            (23,'Flûte traversière Cupronickel  ','La flûte est faite de cupronickel, flûte à touches C avec 16 trous, design exquis et élégant pour satisfaire votre goût.','LIXADA ',null,5,180,'products/flutes/flute-2.webp'),
                                            (24,'Piccolo Ottavino Flûte ','Piccolo Ottavino Flûte De Taille Demi-Taille Cupronickel Plaqué Argent C Tonalité de Clé avec Chiffon Polonais Bâton de Nettoyage','Yamaha ',null,5,124,'products/flutes/flute-3.jpg');
...
VALUES (1,'arnaud', 'arnaud@gmail.com','$2a$10$c/MdR9VXxqo2dAM/1j/A6eMsIkIJe49Q5Wz90cuB130.KFo1QQc/y','arnaud','berg','049999999','Namur henallux','homme','ROLE_ADMIN',1,1,1,1), --password
       ...
       (7,'dubisy','dubisy@gmail.com','$2a$10$u0RE67ioREeOvWsLwAfmiOGzpbek0sDzZPYtoEpecr0AWnBkRsYV6','dubisy','francoise','047878798','Namur-Liège','femme','ROLE_ADMIN',1,1,1,1); --professeur
